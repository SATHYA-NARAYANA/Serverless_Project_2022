...
# Step 4: 
Next give any name to user " here i gave Jerry" and also assign Access key - programmatic access
<p align="center">
     <img width="900" height="400" src="https://github.com/SATHYA-NARAYANA/Serverless_Project_2022/blob/main/IAM/4.png">
</p>

# Step 5: 
Next click on existing access role to user 
<p align="center">
...
# Step 6: 
Next Give user an access " Here i am assigning user Administrative access "
<p align="center">
...
# Step 8: 
Finally you have finished creating User
```diff
